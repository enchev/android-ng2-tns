...
var Parse5DomAdapter = (function (_super) {
    ...
    Parse5DomAdapter.prototype.on = function (el /** TODO #9100 */, evt /** TODO #9100 */, listener /** TODO #9100 */) {
        ...
        if (lang_facade_1.isBlank(listenersMap)) {
            var listenersMap = collection_facade_1.StringMapWrapper.create();
            el._eventListenersMap = listenersMap;
        }
        var listeners = collection_facade_1.StringMapWrapper.get(listenersMap, evt);
        if (lang_facade_1.isBlank(listeners)) {
            listeners = [];
        }
        listeners.push(listener);
        collection_facade_1.StringMapWrapper.set(listenersMap, evt, listeners);
    };
    Parse5DomAdapter.prototype.onAndCancel = function (el /** TODO #9100 */, evt /** TODO #9100 */, listener /** TODO #9100 */) {
        this.on(el, evt, listener);
        return function () {
            collection_facade_1.ListWrapper.remove(collection_facade_1.StringMapWrapper.get(el._eventListenersMap, evt), listener);
        };
    };
    Parse5DomAdapter.prototype.dispatchEvent = function (el /** TODO #9100 */, evt /** TODO #9100 */) {
        if (lang_facade_1.isBlank(evt.target)) {
            evt.target = el;
        }
        if (lang_facade_1.isPresent(el._eventListenersMap)) {
            var listeners = collection_facade_1.StringMapWrapper.get(el._eventListenersMap, evt.type);
            if (lang_facade_1.isPresent(listeners)) {
                for (var i = 0; i < listeners.length; i++) {
                    listeners[i](evt);
                }
            }
        }
        if (lang_facade_1.isPresent(el.parent)) {
            this.dispatchEvent(el.parent, evt);
        }
        if (lang_facade_1.isPresent(el._window)) {
    ...
    Parse5DomAdapter.prototype.isPrevented = function (evt /** TODO #9100 */) {
        return lang_facade_1.isPresent(evt.returnValue) && !evt.returnValue;
    };
    ...
    Parse5DomAdapter.prototype.childNodesAsList = function (el /** TODO #9100 */) {
        ...
        var res = collection_facade_1.ListWrapper.createFixedSize(childNodes.length);
    ...
    Parse5DomAdapter.prototype.removeChild = function (el /** TODO #9100 */, node /** TODO #9100 */) {
        if (collection_facade_1.ListWrapper.contains(el.childNodes, node)) {
            this.remove(node);
        }
    };
    ...
    Parse5DomAdapter.prototype.getText = function (el /** TODO #9100 */, isRecursive) {
        ...
        else if (lang_facade_1.isBlank(el.childNodes) || el.childNodes.length == 0) {
            return '';
        }
        else {
            var textContent = '';
    ...
    Parse5DomAdapter.prototype.removeAttribute = function (element /** TODO #9100 */, attribute) {
        if (attribute) {
            collection_facade_1.StringMapWrapper.delete(element.attribs, attribute);
        }
    };
    ...
    Parse5DomAdapter.prototype.createHtmlDocument = function () {
        ...
        collection_facade_1.StringMapWrapper.set(newDoc, 'head', head);
        collection_facade_1.StringMapWrapper.set(newDoc, 'body', body);
        collection_facade_1.StringMapWrapper.set(newDoc, '_window', collection_facade_1.StringMapWrapper.create());
        return newDoc;
    };
    ...
    Parse5DomAdapter.prototype.hasShadowRoot = function (node /** TODO #9100 */) { return lang_facade_1.isPresent(node.shadowRoot); };
    ...
    Parse5DomAdapter.prototype._buildRules = function (parsedRules /** TODO #9100 */, css /** TODO #9100 */) {
        ...
        for (var i = 0; i < parsedRules.length; i++) {
            ...
            var rule = collection_facade_1.StringMapWrapper.create();
            collection_facade_1.StringMapWrapper.set(rule, 'cssText', css);
            collection_facade_1.StringMapWrapper.set(rule, 'style', { content: '', cssText: '' });
            if (parsedRule.type == 'rule') {
                collection_facade_1.StringMapWrapper.set(rule, 'type', 1);
                collection_facade_1.StringMapWrapper.set(rule, 'selectorText', parsedRule.selectors.join(', ')
                    .replace(/\s{2,}/g, ' ')
                    .replace(/\s*~\s*/g, ' ~ ')
                    .replace(/\s*\+\s*/g, ' + ')
                    .replace(/\s*>\s*/g, ' > ')
                ...
                for (var j = 0; j < parsedRule.declarations.length; j++) {
                    ...
                    collection_facade_1.StringMapWrapper.set(collection_facade_1.StringMapWrapper.get(rule, 'style'), declaration.property, declaration.value);
                    collection_facade_1.StringMapWrapper.get(rule, 'style').cssText +=
                        declaration.property + ': ' + declaration.value + ';';
                }
            }
            else if (parsedRule.type == 'media') {
                collection_facade_1.StringMapWrapper.set(rule, 'type', 4);
                collection_facade_1.StringMapWrapper.set(rule, 'media', { mediaText: parsedRule.media });
                if (parsedRule.rules) {
                    collection_facade_1.StringMapWrapper.set(rule, 'cssRules', this._buildRules(parsedRule.rules));
                }
            }
            rules.push(rule);
        }
    ...
    Parse5DomAdapter.prototype.setGlobalVar = function (path, value) { lang_facade_1.setValueOnPath(lang_facade_1.global, path, value); };
    Parse5DomAdapter.prototype.supportsWebAnimation = function () { return false; };
    Parse5DomAdapter.prototype.performanceNow = function () { return lang_facade_1.DateWrapper.toMillis(lang_facade_1.DateWrapper.now()); };
